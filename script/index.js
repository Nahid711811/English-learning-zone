...
const displayWordDetails = (word) => {
    ...
    detailsBox.innerHTML = `
            <div class="">
                <h2 class="text-2xl font-bold">${word.word} (<i class="fa-solid fa-microphone"></i>    :${word.pronunciation})
                </h2>
            </div>
            <div class="">
...
const displayLevelWord = (words) => {
    ...
    if (words.length == 0) {
         wordContainer.innerHTML = `
         <div class="text-center bg-sky-300 col-span-full rounded-xl    py-10 space-y-6 font-bangla">
            <img class="mx-auto" src="./photo/alert-error.png" alt="">
